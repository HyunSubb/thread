...
import com.example.nhnacademy.count.SharedCounter4;
import com.example.nhnacademy.thread.CounterIncreaseHandler;
import com.example.nhnacademy.thread.CounterIncreaseHandler4;
...
public class App2_4 {
    public static void main( String[] args ) {
        ...
        SharedCounter4 sharedCounter = new SharedCounter4(0l);

        //counterIncreaseHandler 객체를 생성 합니다.
        CounterIncreaseHandler4 counterIncreaseHandler = new CounterIncreaseHandler4(sharedCounter);
