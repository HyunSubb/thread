...
import com.example.nhnacademy.count.SharedCounter3;
import com.example.nhnacademy.thread.CounterIncreaseHandler;
import com.example.nhnacademy.thread.CounterIncreaseHandler3;
...
public class App2_3 {
    public static void main( String[] args )
    {
        ...
        SharedCounter3 sharedCounter = new SharedCounter3(0l);

        //counterIncreaseHandler 객체를 생성 합니다.
        CounterIncreaseHandler3 counterIncreaseHandler = new CounterIncreaseHandler3(sharedCounter);
