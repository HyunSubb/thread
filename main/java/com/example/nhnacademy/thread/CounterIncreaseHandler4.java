...
/**
 * CounterIncreaseHandler4
 */

@Slf4j
public class CounterIncreaseHandler4 implements Runnable{
    private final SharedCounter4 sharedCounter;

    public CounterIncreaseHandler4(SharedCounter4 sharedCounter) {
