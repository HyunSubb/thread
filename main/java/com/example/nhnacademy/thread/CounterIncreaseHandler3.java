...
@Slf4j
public class CounterIncreaseHandler3 implements Runnable{
    private final SharedCounter3 sharedCounter;

    public CounterIncreaseHandler3(SharedCounter3 sharedCounter) {
